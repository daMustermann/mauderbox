...
import { ExpandableTextarea } from './TextInputModal';

const INSTRUCT_PRESETS = [
  { label: 'Slow & Clear', text: 'Speak slowly and clearly.' },
  { label: 'Warm', text: 'Speak in a warm and friendly tone.' },
  { label: 'Professional', text: 'Speak in a professional and authoritative tone.' },
  { label: 'Excited', text: 'Speak in an excited and energetic tone.' },
  { label: 'Whisper', text: 'Whisper the text.' },
  { label: 'Storyteller', text: 'Speak like a storyteller, engaging and expressive.' },
];
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <ExpandableTextarea
                      ...
                      maxLength={5000}
                      modalTitle="Text to Speak"
                      modalDescription="Bearbeiten Sie den zu sprechenden Text in der vergrößerten Ansicht."
                    />
                  </FormControl>
