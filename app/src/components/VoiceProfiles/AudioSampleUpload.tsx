...
export function AudioSampleUpload({
  ...
  const isAudioFile = (inputFile: File) => {
      ...
      <FormControl>
        <div className="flex flex-col gap-2">
          <input
            ...
            className="hidden"
          />
          {/* biome-ignore lint/a11y/noStaticElementInteractions: Drag-and-drop zone needs pointer events */}
          <div
            onDragOver={(e) => {
              e.preventDefault();
              setIsDragging(true);
            ...
            className={`flex flex-col items-center justify-center gap-4 p-4 border-2 rounded-lg transition-colors min-h-45 ${
              file
            ...
            {!file ? (
              <>
                ...
                <p className="text-sm text-muted-foreground text-center">
                  Click to choose a file or drag and drop. Files longer than 30 seconds will be
                  trimmed for voice creation.
                </p>
              </>
            ) : (
              <>
