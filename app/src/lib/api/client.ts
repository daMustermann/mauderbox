...
class ApiClient {
  ...
  async toggleFavorite(generationId: string): Promise<GenerationResponse> {
    return this.request<GenerationResponse>(`/history/${generationId}/favorite`, {
      method: 'POST',
    });
  }
  ...
  async getPromptEnhancerStatus(): Promise<PromptEnhancerStatus> {
    return this.request<PromptEnhancerStatus>('/prompt-enhancer/status');
  }

  async loadPromptEnhancer(): Promise<{ message: string; loaded: boolean; loading?: boolean }> {
    return this.request<{ message: string; loaded: boolean; loading?: boolean }>(
      '/prompt-enhancer/load',
      {
        method: 'POST',
      },
    );
  ...
  async unloadPromptEnhancer(): Promise<{ message: string; loaded: boolean }> {
    return this.request<{ message: string; loaded: boolean }>('/prompt-enhancer/unload', {
      method: 'POST',
    });
  }

  async enhancePrompt(data: PromptEnhanceRequest): Promise<PromptEnhanceResponse> {
    return this.request<PromptEnhanceResponse>('/prompt-enhancer/enhance', {
      method: 'POST',
      body: JSON.stringify(data),
    });
  }
