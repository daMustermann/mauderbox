...
// biome-ignore lint/complexity/noStaticOnlyClass: Generated client uses static methods
export class DefaultService {
   ...
   * @throws ApiError
   */
  public static getStatsHistoryStatsGet(): CancelablePromise<unknown> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/history/stats',
    });
   ...
   * @throws ApiError
   */
  public static unloadModelModelsUnloadPost(): CancelablePromise<unknown> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/models/unload',
    });
